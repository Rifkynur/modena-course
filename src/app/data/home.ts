...
export const ourCourses = [
    {
     ...
     {
        id:5,
        img: '/ourCourses/Image4.png',
        times:'10 Weeks',
        levels:'Intermediate',
        teacher:"Micheal Adams",
