  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 gap-4 md:py-16 lg:gap-5">
      ...
      <div className="flex items-center gap-2 mt-5 md:mt-10">
        <Button className="bg-orange-400 hover:bg-orange-600 md:px-5 md:text-xl">
          Explore Courses
        </Button>
        <Button className="bg-white text-black hover:bg-orange-400 hover:text-white md:text-xl">
          View Pricing
        </Button>
      </div>
    </div>
